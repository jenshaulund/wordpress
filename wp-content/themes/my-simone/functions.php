...
function my_simone_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'my-simone' ),
	) );
...
function my_simone_scripts() {
	...
	wp_enqueue_style( 'my-simone-google-fonts', 'https://fonts.googleapis.com/css?family=Lato:400,100,400italic,700,900,900italic|PT+Serif:400,400italic,700,700italic');

	wp_enqueue_style( 'my-simone-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css');
